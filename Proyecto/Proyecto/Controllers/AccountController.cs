...
namespace Proyecto.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> CrearUsuario(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var logica = new UsuarioLogica();
                logica.AgregarUsuario(logica.GetUsuario(user.Id));
            }
        ...
        public ActionResult Edit(string id)
        {
            ...
            UsuarioModelo usuarioModelo = new UsuarioLogica().EditarUsuario(id);
        ...
        public ActionResult Details(string id)
        {
            ...
            UsuarioModelo usuarioModelo = new UsuarioLogica().GetUsuario(id);
            if (usuarioModelo == null)
            {
                return HttpNotFound();
            }
